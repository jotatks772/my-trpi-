...
import { AirlineLogo, BagIcon, CloseIcon, InfoIcon, UserIcon, WarningIcon } from './icons/Icons';
...
const FlightDetailsModal: React.FC<FlightDetailsModalProps> = ({ flight, onClose, onProceedToPayment }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-end" aria-modal="true" role="dialog" onClick={onClose}>
      <div className="bg-gray-100 w-full max-w-2xl h-full flex flex-col" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
                ...
                {[
                    ...
                    <div key={item.type} className="flex items-start gap-4 py-3 first:pb-3 last:pt-3 border-t first:border-t-0">
                        <AirlineLogo airline={item.flight.airline} className="w-6 h-6 mt-1 flex-shrink-0" />
